...
date=$(date +"%Y-%m-%d")
clear
echo " VPS Data Backup By EffataIDStore "
sleep 1
echo ""
...
clear
echo -e "\033[1;37mVPS Data Backup By EffataIDStore\033[0m
\033[1;37mTelegram : https://t.me/CRSe7en2nd / @CRSe7en2nd\033[0m"
echo ""
